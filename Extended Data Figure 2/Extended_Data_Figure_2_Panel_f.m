function Extended_Data_Figure_2_Panel_f
...
d_Dic = zeros(2, SZ); %%  derivative of altruism, \bar{p}
...
for iter = 1:SZ 
    ...
    d_Dic(1, iter) = -1/6 * Lambda_static(2) - 1/12 * Lambda_static(3);
    d_Dic(2, iter) = -1/6 * Lambda_dynamic(2) - 1/12 * Lambda_dynamic(3);
...
axis([0.27 0.50 0.27 0.50]);
% % axis([0.25 0.5001 0.25 0.5001]);
xticks(0.3:0.1:0.5);
yticks(0.3:0.1:0.5);
xtickformat('%.1f');
ytickformat('%.1f');
