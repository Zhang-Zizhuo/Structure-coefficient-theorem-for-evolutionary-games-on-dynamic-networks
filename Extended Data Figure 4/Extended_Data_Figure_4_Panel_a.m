function Extended_Data_Figure_4_Panel_a
...
% -------- Cooperation threshold (b/c)^* --------
K1s = Lambda_static_1 - Lambda_static_2;
K2s = Lambda_static_1 + Lambda_static_2 + Lambda_static_3;
bc_static = K2s ./ K1s;

K1d = Lambda_dynamic_1 - Lambda_dynamic_2;
K2d = Lambda_dynamic_1 + Lambda_dynamic_2 + Lambda_dynamic_3;
bc_dynamic = K2d ./ K1d;
...
bc_dynamic = 1 ./ bc_dynamic;
bc_static = 1 ./ bc_static;
surf(X, Y, bc_dynamic, ...
    'FaceColor', blue, ...
...
zlabel('$(c/b)^*$', 'Interpreter', 'latex', 'FontSize', 18);
